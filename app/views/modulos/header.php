    ...
    <nav class="nav">
      ...
      <div class="dropdown">
        <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
          <span class="logged-name hidden-md-down">Administrador Sistema</span>
        ...
        <div class="dropdown-menu dropdown-menu-header wd-250">
          <div class="tx-center">
            ...
            <h6 class="logged-fullname">Administrador Sistema</h6>
            <p>admin@globaltyt.com</p>
          </div>
          <hr>
          <ul class="list-unstyled user-profile-nav">
            <!--<li><a href=""><i class="icon ion-locked"></i> Cambiar Clave</a></li>-->
