...
abstract class RecordSet {
     ...
     * FORMATO_JSON. Si no se recibe una de estas
     ...
     */
    public function get($posicion = RecordSet::REGISTRO_ACTUAL, $formato = RecordSet::FORMATO_OBJETO) {
        ...
        if ($posicion >= 0) {
            ...
            switch ($posicion) {
                case RecordSet::REGISTRO_ACTUAL: {
                        if ($this->apuntador < 0 || $this->apuntador >= ($this->cantidad))
